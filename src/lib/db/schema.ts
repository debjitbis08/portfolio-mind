...
export const transactions = sqliteTable(
  "transactions",
  {
    ...
    stt: real("stt").notNull().default(0),
    stampDuty: real("stamp_duty").notNull().default(0),
    exchangeCharges: real("exchange_charges").notNull().default(0),
    sebiCharges: real("sebi_charges").notNull().default(0),
    ipftCharges: real("ipft_charges").notNull().default(0),
